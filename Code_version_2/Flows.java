...
public class Flows {
	...
	public static short BAN_HARD_TIMEOUT = 15; 
	public static short BAN_DEFAULT_IDLE_TIMEOUT = 0; // in seconds
...
//				logger.info("Flow from port {} forwarded to port {}; match: {}", new Object[] { pin.getInPort().getPortNumber(), outPort.getPortNumber(), m.toString() });
	...
	public static void allTraceARP(
		...
		public static void banFlow(IOFSwitch sw, OFPacketIn pin, FloodlightContext cntx, OFPort outPort, MacAddress srcMac) {
		//PacketExtractor extractor = new PacketExtractor(cntx);
		OFFlowMod.Builder fmb = sw.getOFFactory().buildFlowAdd();
		// Match m = createMatchFromPacket(sw, pin.getInPort(), cntx); // Commented out as we are not using port specific match
		Match.Builder mb = sw.getOFFactory().buildMatch();
		mb.setExact(MatchField.ETH_TYPE, EthType.IPv4) 
		...
		fmb.setMatch(mb.build()) // Use the match builder directly
			...
			.setHardTimeout(BAN_HARD_TIMEOUT)
		...
		try {
			sw.write(fmb.build());
			// logger.info("Flow is set to drop packets; match: {}",
			// 			new Object[] { m.toString() }); // Removed pin.getInPort().getPortNumber() from logging
		} catch (Exception e) {
			logger.error("Error {}", e);
		}
	...
	public static void sendPacktOut(
            IOFSwitch sw, 
            OFMessage msg,
            FloodlightContext cntx,
            IPv4Address specificSrcIp, 
		...
		public static void allTraceSendPacketOut(
            IOFSwitch sw, 
            OFMessage msg,
            FloodlightContext cntx) {
    	
			        sendPacktOut(sw, msg, cntx, IPv4Address.of("10.0.0.1"), IPv4Address.of("10.0.0.2"), DatapathId.of("00:00:00:00:00:00:00:01"), OFPort.of(1), OFPort.of(2));
    	sendPacktOut(sw, msg, cntx, IPv4Address.of("10.0.0.1"), IPv4Address.of("10.0.0.2"), DatapathId.of("00:00:00:00:00:00:00:02"), OFPort.of(1), OFPort.of(2));
    	sendPacktOut(sw, msg, cntx, IPv4Address.of("10.0.0.1"), IPv4Address.of("10.0.0.2"), DatapathId.of("00:00:00:00:00:00:00:03"), OFPort.of(1), OFPort.of(2));
    	sendPacktOut(sw, msg, cntx, IPv4Address.of("10.0.0.1"), IPv4Address.of("10.0.0.2"), DatapathId.of("00:00:00:00:00:00:00:06"), OFPort.of(1), OFPort.of(4));

    	sendPacktOut(sw, msg, cntx, IPv4Address.of("10.0.0.1"), IPv4Address.of("10.0.0.3"), DatapathId.of("00:00:00:00:00:00:00:01"), OFPort.of(1), OFPort.of(2));
    	sendPacktOut(sw, msg, cntx, IPv4Address.of("10.0.0.1"), IPv4Address.of("10.0.0.3"), DatapathId.of("00:00:00:00:00:00:00:02"), OFPort.of(1), OFPort.of(3));
    	sendPacktOut(sw, msg, cntx, IPv4Address.of("10.0.0.1"), IPv4Address.of("10.0.0.3"), DatapathId.of("00:00:00:00:00:00:00:04"), OFPort.of(1), OFPort.of(3));
    	sendPacktOut(sw, msg, cntx, IPv4Address.of("10.0.0.1"), IPv4Address.of("10.0.0.3"), DatapathId.of("00:00:00:00:00:00:00:07"), OFPort.of(2), OFPort.of(4));

    	sendPacktOut(sw, msg, cntx, IPv4Address.of("10.0.0.1"), IPv4Address.of("10.0.0.4"), DatapathId.of("00:00:00:00:00:00:00:01"), OFPort.of(1), OFPort.of(2));
    	sendPacktOut(sw, msg, cntx, IPv4Address.of("10.0.0.1"), IPv4Address.of("10.0.0.4"), DatapathId.of("00:00:00:00:00:00:00:02"), OFPort.of(1), OFPort.of(3));
    	sendPacktOut(sw, msg, cntx, IPv4Address.of("10.0.0.1"), IPv4Address.of("10.0.0.4"), DatapathId.of("00:00:00:00:00:00:00:04"), OFPort.of(1), OFPort.of(4));
    	sendPacktOut(sw, msg, cntx, IPv4Address.of("10.0.0.1"), IPv4Address.of("10.0.0.4"), DatapathId.of("00:00:00:00:00:00:00:08"), OFPort.of(2), OFPort.of(4));

    	sendPacktOut(sw, msg, cntx, IPv4Address.of("10.0.0.1"), IPv4Address.of("10.0.0.5"), DatapathId.of("00:00:00:00:00:00:00:01"), OFPort.of(1), OFPort.of(2));
    	sendPacktOut(sw, msg, cntx, IPv4Address.of("10.0.0.1"), IPv4Address.of("10.0.0.5"), DatapathId.of("00:00:00:00:00:00:00:02"), OFPort.of(1), OFPort.of(4));
    	sendPacktOut(sw, msg, cntx, IPv4Address.of("10.0.0.1"), IPv4Address.of("10.0.0.5"), DatapathId.of("00:00:00:00:00:00:00:05"), OFPort.of(1), OFPort.of(5));
    	sendPacktOut(sw, msg, cntx, IPv4Address.of("10.0.0.1"), IPv4Address.of("10.0.0.5"), DatapathId.of("00:00:00:00:00:00:00:09"), OFPort.of(3), OFPort.of(4));

    	sendPacktOut(sw, msg, cntx, IPv4Address.of("10.0.0.2"), IPv4Address.of("10.0.0.1"), DatapathId.of("00:00:00:00:00:00:00:06"), OFPort.of(4), OFPort.of(1));
    	sendPacktOut(sw, msg, cntx, IPv4Address.of("10.0.0.2"), IPv4Address.of("10.0.0.1"), DatapathId.of("00:00:00:00:00:00:00:03"), OFPort.of(2), OFPort.of(1));
    	sendPacktOut(sw, msg, cntx, IPv4Address.of("10.0.0.2"), IPv4Address.of("10.0.0.1"), DatapathId.of("00:00:00:00:00:00:00:02"), OFPort.of(2), OFPort.of(1));
    	sendPacktOut(sw, msg, cntx, IPv4Address.of("10.0.0.2"), IPv4Address.of("10.0.0.1"), DatapathId.of("00:00:00:00:00:00:00:01"), OFPort.of(2), OFPort.of(1));

    	sendPacktOut(sw, msg, cntx, IPv4Address.of("10.0.0.2"), IPv4Address.of("10.0.0.3"), DatapathId.of("00:00:00:00:00:00:00:06"), OFPort.of(4), OFPort.of(1));
    	sendPacktOut(sw, msg, cntx, IPv4Address.of("10.0.0.2"), IPv4Address.of("10.0.0.3"), DatapathId.of("00:00:00:00:00:00:00:03"), OFPort.of(2), OFPort.of(3));
    	sendPacktOut(sw, msg, cntx, IPv4Address.of("10.0.0.2"), IPv4Address.of("10.0.0.3"), DatapathId.of("00:00:00:00:00:00:00:07"), OFPort.of(1), OFPort.of(4));

    	sendPacktOut(sw, msg, cntx, IPv4Address.of("10.0.0.2"), IPv4Address.of("10.0.0.4"), DatapathId.of("00:00:00:00:00:00:00:06"), OFPort.of(4), OFPort.of(1));
    	sendPacktOut(sw, msg, cntx, IPv4Address.of("10.0.0.2"), IPv4Address.of("10.0.0.4"), DatapathId.of("00:00:00:00:00:00:00:03"), OFPort.of(2), OFPort.of(1));
    	sendPacktOut(sw, msg, cntx, IPv4Address.of("10.0.0.2"), IPv4Address.of("10.0.0.4"), DatapathId.of("00:00:00:00:00:00:00:02"), OFPort.of(2), OFPort.of(3));
    	sendPacktOut(sw, msg, cntx, IPv4Address.of("10.0.0.2"), IPv4Address.of("10.0.0.4"), DatapathId.of("00:00:00:00:00:00:00:04"), OFPort.of(1), OFPort.of(4));
    	sendPacktOut(sw, msg, cntx, IPv4Address.of("10.0.0.2"), IPv4Address.of("10.0.0.4"), DatapathId.of("00:00:00:00:00:00:00:08"), OFPort.of(2), OFPort.of(4));

    	sendPacktOut(sw, msg, cntx, IPv4Address.of("10.0.0.2"), IPv4Address.of("10.0.0.5"), DatapathId.of("00:00:00:00:00:00:00:06"), OFPort.of(4), OFPort.of(1));
    	sendPacktOut(sw, msg, cntx, IPv4Address.of("10.0.0.2"), IPv4Address.of("10.0.0.5"), DatapathId.of("00:00:00:00:00:00:00:03"), OFPort.of(2), OFPort.of(1));
    	sendPacktOut(sw, msg, cntx, IPv4Address.of("10.0.0.2"), IPv4Address.of("10.0.0.5"), DatapathId.of("00:00:00:00:00:00:00:02"), OFPort.of(2), OFPort.of(4));
    	sendPacktOut(sw, msg, cntx, IPv4Address.of("10.0.0.2"), IPv4Address.of("10.0.0.5"), DatapathId.of("00:00:00:00:00:00:00:05"), OFPort.of(1), OFPort.of(5));
    	sendPacktOut(sw, msg, cntx, IPv4Address.of("10.0.0.2"), IPv4Address.of("10.0.0.5"), DatapathId.of("00:00:00:00:00:00:00:09"), OFPort.of(3), OFPort.of(4));

    	sendPacktOut(sw, msg, cntx, IPv4Address.of("10.0.0.3"), IPv4Address.of("10.0.0.1"), DatapathId.of("00:00:00:00:00:00:00:07"), OFPort.of(4), OFPort.of(2));
    	sendPacktOut(sw, msg, cntx, IPv4Address.of("10.0.0.3"), IPv4Address.of("10.0.0.1"), DatapathId.of("00:00:00:00:00:00:00:04"), OFPort.of(3), OFPort.of(1));
    	sendPacktOut(sw, msg, cntx, IPv4Address.of("10.0.0.3"), IPv4Address.of("10.0.0.1"), DatapathId.of("00:00:00:00:00:00:00:02"), OFPort.of(3), OFPort.of(1));
    	sendPacktOut(sw, msg, cntx, IPv4Address.of("10.0.0.3"), IPv4Address.of("10.0.0.1"), DatapathId.of("00:00:00:00:00:00:00:01"), OFPort.of(2), OFPort.of(1));

    	sendPacktOut(sw, msg, cntx, IPv4Address.of("10.0.0.3"), IPv4Address.of("10.0.0.2"), DatapathId.of("00:00:00:00:00:00:00:07"), OFPort.of(4), OFPort.of(1));
    	sendPacktOut(sw, msg, cntx, IPv4Address.of("10.0.0.3"), IPv4Address.of("10.0.0.2"), DatapathId.of("00:00:00:00:00:00:00:03"), OFPort.of(3), OFPort.of(2));
    	sendPacktOut(sw, msg, cntx, IPv4Address.of("10.0.0.3"), IPv4Address.of("10.0.0.2"), DatapathId.of("00:00:00:00:00:00:00:06"), OFPort.of(1), OFPort.of(4));

    	sendPacktOut(sw, msg, cntx, IPv4Address.of("10.0.0.3"), IPv4Address.of("10.0.0.4"), DatapathId.of("00:00:00:00:00:00:00:07"), OFPort.of(4), OFPort.of(2));
    	sendPacktOut(sw, msg, cntx, IPv4Address.of("10.0.0.3"), IPv4Address.of("10.0.0.4"), DatapathId.of("00:00:00:00:00:00:00:04"), OFPort.of(3), OFPort.of(4));
    	sendPacktOut(sw, msg, cntx, IPv4Address.of("10.0.0.3"), IPv4Address.of("10.0.0.4"), DatapathId.of("00:00:00:00:00:00:00:08"), OFPort.of(2), OFPort.of(4));

    	sendPacktOut(sw, msg, cntx, IPv4Address.of("10.0.0.3"), IPv4Address.of("10.0.0.5"), DatapathId.of("00:00:00:00:00:00:00:07"), OFPort.of(4), OFPort.of(2));
    	sendPacktOut(sw, msg, cntx, IPv4Address.of("10.0.0.3"), IPv4Address.of("10.0.0.5"), DatapathId.of("00:00:00:00:00:00:00:04"), OFPort.of(3), OFPort.of(1));
    	sendPacktOut(sw, msg, cntx, IPv4Address.of("10.0.0.3"), IPv4Address.of("10.0.0.5"), DatapathId.of("00:00:00:00:00:00:00:02"), OFPort.of(3), OFPort.of(4));
    	sendPacktOut(sw, msg, cntx, IPv4Address.of("10.0.0.3"), IPv4Address.of("10.0.0.5"), DatapathId.of("00:00:00:00:00:00:00:05"), OFPort.of(1), OFPort.of(5));
    	sendPacktOut(sw, msg, cntx, IPv4Address.of("10.0.0.3"), IPv4Address.of("10.0.0.5"), DatapathId.of("00:00:00:00:00:00:00:09"), OFPort.of(3), OFPort.of(4));

    	sendPacktOut(sw, msg, cntx, IPv4Address.of("10.0.0.4"), IPv4Address.of("10.0.0.1"), DatapathId.of("00:00:00:00:00:00:00:08"), OFPort.of(4), OFPort.of(2));
    	sendPacktOut(sw, msg, cntx, IPv4Address.of("10.0.0.4"), IPv4Address.of("10.0.0.1"), DatapathId.of("00:00:00:00:00:00:00:04"), OFPort.of(4), OFPort.of(1));
    	sendPacktOut(sw, msg, cntx, IPv4Address.of("10.0.0.4"), IPv4Address.of("10.0.0.1"), DatapathId.of("00:00:00:00:00:00:00:02"), OFPort.of(3), OFPort.of(1));
    	sendPacktOut(sw, msg, cntx, IPv4Address.of("10.0.0.4"), IPv4Address.of("10.0.0.1"), DatapathId.of("00:00:00:00:00:00:00:01"), OFPort.of(2), OFPort.of(1));

    	sendPacktOut(sw, msg, cntx, IPv4Address.of("10.0.0.4"), IPv4Address.of("10.0.0.2"), DatapathId.of("00:00:00:00:00:00:00:08"), OFPort.of(4), OFPort.of(2));
    	sendPacktOut(sw, msg, cntx, IPv4Address.of("10.0.0.4"), IPv4Address.of("10.0.0.2"), DatapathId.of("00:00:00:00:00:00:00:04"), OFPort.of(4), OFPort.of(1));
    	sendPacktOut(sw, msg, cntx, IPv4Address.of("10.0.0.4"), IPv4Address.of("10.0.0.2"), DatapathId.of("00:00:00:00:00:00:00:02"), OFPort.of(3), OFPort.of(2));
    	sendPacktOut(sw, msg, cntx, IPv4Address.of("10.0.0.4"), IPv4Address.of("10.0.0.2"), DatapathId.of("00:00:00:00:00:00:00:03"), OFPort.of(1), OFPort.of(2));
    	sendPacktOut(sw, msg, cntx, IPv4Address.of("10.0.0.4"), IPv4Address.of("10.0.0.2"), DatapathId.of("00:00:00:00:00:00:00:06"), OFPort.of(1), OFPort.of(4));

    	sendPacktOut(sw, msg, cntx, IPv4Address.of("10.0.0.4"), IPv4Address.of("10.0.0.3"), DatapathId.of("00:00:00:00:00:00:00:08"), OFPort.of(4), OFPort.of(2));
    	sendPacktOut(sw, msg, cntx, IPv4Address.of("10.0.0.4"), IPv4Address.of("10.0.0.3"), DatapathId.of("00:00:00:00:00:00:00:04"), OFPort.of(4), OFPort.of(3));
    	sendPacktOut(sw, msg, cntx, IPv4Address.of("10.0.0.4"), IPv4Address.of("10.0.0.3"), DatapathId.of("00:00:00:00:00:00:00:07"), OFPort.of(2), OFPort.of(4));

    	sendPacktOut(sw, msg, cntx, IPv4Address.of("10.0.0.4"), IPv4Address.of("10.0.0.5"), DatapathId.of("00:00:00:00:00:00:00:08"), OFPort.of(4), OFPort.of(3));
    	sendPacktOut(sw, msg, cntx, IPv4Address.of("10.0.0.4"), IPv4Address.of("10.0.0.5"), DatapathId.of("00:00:00:00:00:00:00:05"), OFPort.of(4), OFPort.of(5));
    	sendPacktOut(sw, msg, cntx, IPv4Address.of("10.0.0.4"), IPv4Address.of("10.0.0.5"), DatapathId.of("00:00:00:00:00:00:00:09"), OFPort.of(3), OFPort.of(4));

    	sendPacktOut(sw, msg, cntx, IPv4Address.of("10.0.0.5"), IPv4Address.of("10.0.0.1"), DatapathId.of("00:00:00:00:00:00:00:09"), OFPort.of(4), OFPort.of(3));
    	sendPacktOut(sw, msg, cntx, IPv4Address.of("10.0.0.5"), IPv4Address.of("10.0.0.1"), DatapathId.of("00:00:00:00:00:00:00:05"), OFPort.of(5), OFPort.of(1));
    	sendPacktOut(sw, msg, cntx, IPv4Address.of("10.0.0.5"), IPv4Address.of("10.0.0.1"), DatapathId.of("00:00:00:00:00:00:00:02"), OFPort.of(4), OFPort.of(1));
    	sendPacktOut(sw, msg, cntx, IPv4Address.of("10.0.0.5"), IPv4Address.of("10.0.0.1"), DatapathId.of("00:00:00:00:00:00:00:01"), OFPort.of(2), OFPort.of(1));

    	sendPacktOut(sw, msg, cntx, IPv4Address.of("10.0.0.5"), IPv4Address.of("10.0.0.2"), DatapathId.of("00:00:00:00:00:00:00:09"), OFPort.of(4), OFPort.of(3));
    	sendPacktOut(sw, msg, cntx, IPv4Address.of("10.0.0.5"), IPv4Address.of("10.0.0.2"), DatapathId.of("00:00:00:00:00:00:00:05"), OFPort.of(5), OFPort.of(1));
    	sendPacktOut(sw, msg, cntx, IPv4Address.of("10.0.0.5"), IPv4Address.of("10.0.0.2"), DatapathId.of("00:00:00:00:00:00:00:02"), OFPort.of(4), OFPort.of(2));
    	sendPacktOut(sw, msg, cntx, IPv4Address.of("10.0.0.5"), IPv4Address.of("10.0.0.2"), DatapathId.of("00:00:00:00:00:00:00:03"), OFPort.of(1), OFPort.of(2));
    	sendPacktOut(sw, msg, cntx, IPv4Address.of("10.0.0.5"), IPv4Address.of("10.0.0.2"), DatapathId.of("00:00:00:00:00:00:00:06"), OFPort.of(1), OFPort.of(4));

    	sendPacktOut(sw, msg, cntx, IPv4Address.of("10.0.0.5"), IPv4Address.of("10.0.0.3"), DatapathId.of("00:00:00:00:00:00:00:09"), OFPort.of(4), OFPort.of(3));
    	sendPacktOut(sw, msg, cntx, IPv4Address.of("10.0.0.5"), IPv4Address.of("10.0.0.3"), DatapathId.of("00:00:00:00:00:00:00:05"), OFPort.of(5), OFPort.of(1));
    	sendPacktOut(sw, msg, cntx, IPv4Address.of("10.0.0.5"), IPv4Address.of("10.0.0.3"), DatapathId.of("00:00:00:00:00:00:00:02"), OFPort.of(4), OFPort.of(3));
    	sendPacktOut(sw, msg, cntx, IPv4Address.of("10.0.0.5"), IPv4Address.of("10.0.0.3"), DatapathId.of("00:00:00:00:00:00:00:04"), OFPort.of(1), OFPort.of(3));
    	sendPacktOut(sw, msg, cntx, IPv4Address.of("10.0.0.5"), IPv4Address.of("10.0.0.3"), DatapathId.of("00:00:00:00:00:00:00:07"), OFPort.of(2), OFPort.of(4));

    	sendPacktOut(sw, msg, cntx, IPv4Address.of("10.0.0.5"), IPv4Address.of("10.0.0.4"), DatapathId.of("00:00:00:00:00:00:00:09"), OFPort.of(4), OFPort.of(3));
    	sendPacktOut(sw, msg, cntx, IPv4Address.of("10.0.0.5"), IPv4Address.of("10.0.0.4"), DatapathId.of("00:00:00:00:00:00:00:05"), OFPort.of(5), OFPort.of(4));
    	sendPacktOut(sw, msg, cntx, IPv4Address.of("10.0.0.5"), IPv4Address.of("10.0.0.4"), DatapathId.of("00:00:00:00:00:00:00:08"), OFPort.of(3), OFPort.of(4));
